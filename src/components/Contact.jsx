...
function MyPage() {
  ...
  return (
    ...
    <div>
      ...
      <FlipLink href="https://www.linkedin.com/in/shiva-yadav-476660349/" icon={<LinkedinIcon />}>
        Linkedin
      </FlipLink>
      <FlipLink href="https://github.com/SHIVA00202" icon={<GithubIcon />}>
        Github
      </FlipLink>
      <FlipLink href="mailto:workingshivayadav@gmail.com" icon={<GmailIcon />}>
        Gmail
      </FlipLink>
